...
public class throttle extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        jLabel52.setText("• Pozitia initiala a pedalei de acceleratie setata de producator.");

        jLabel36.setText("in sensul invers acelor de ceasornic, pana cand exista un spatiu liber intre surubul de oprire si maneta de acceleratie.");

        jLabel35.setFont(new java.awt.Font("Dialog", 1, 14)); // NOI18N
        jLabel35.setForeground(new java.awt.Color(15, 89, 193));
        jLabel35.setText("Ajustari -");
        ...
        jLabel60.setText(" • Verifica viteza la relanti, si pozitia ajustata a senzorului de acceleratie ( TP ). ");

        jLabel58.setText("• Roteste surubul de oprire in sensul acelor de ceasornic aproximativ 180 de grade (180°). ");

        jLabel55.setText("• Roteste surubul de oprire al manetei de acceleratie");
        ...
        jLabel56.setText("• Asigura-te ca supapa clapetei de acceleratie este inchisa.");

        jLabel34.setFont(new java.awt.Font("Dialog", 1, 14)); // NOI18N
        jLabel34.setForeground(new java.awt.Color(15, 89, 193));
        jLabel34.setText("Pozitia initiala a pedalei de acceleratie");

        jLabel53.setText("• Daca ajustarea este modificata din greseala, folositi urmatorii pasi:");

        jLabel54.setText("• Asigura-te ca, cablul de acceleratie este lasat putin mai lung si se misca cu lejeritate.");

        jLabel61.setText(" • Verifica ca valva de acceleratie se deschide complet cand pedala de acceleratie este libera.");

        jLabel57.setText("• Roteste surubul de oprire in sensul acelor de ceasornic, pana cand face contact foarte putin cu maneta de acceleratie. ");

        jLabel59.setText("• Ajusteaza cablul de acceleratie daca este necesar. ");
