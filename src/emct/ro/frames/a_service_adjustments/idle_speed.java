...
public class idle_speed extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        jLabel14.setText("• Permite rularea motorului in gol pentru doua(2) minute.");

        jLabel12.setText("• Porneste motorul.");

        jLabel1.setText("• Viteza la Relanti controlata electronic.");
        ...
        jLabel2.setText("• Nicio ajustare posibila");

        jLabel5.setText("• Daca viteza la Relanti nu este cea specificata: Verifica pentru scurgeri in sistemul de admisie. Efectueaza testele electronice cat si cele ale componentelor. ");

        jLabel9.setText("• Verifica daca motorul este oprit");

        jLabel4.setFont(new java.awt.Font("Dialog", 1, 14)); // NOI18N
        jLabel4.setForeground(new java.awt.Color(15, 89, 193));
        jLabel4.setText("Ajustari - exceptand Passat");

        jLabel8.setText("• Poate fi ajustat doar folosind echipament specific pentru diagnostic.");

        jLabel3.setFont(new java.awt.Font("Dialog", 1, 14)); // NOI18N
        jLabel3.setForeground(new java.awt.Color(15, 89, 193));
        jLabel3.setText("Viteza la Relanti");
        ...
        jLabel6.setText("Ajustari  -  Passat  -");

        jLabel11.setText("• Conecteaza furtunul de aer al carterului.");

        jLabel10.setText("• Deconecteaza furtunul de aer al carterului de la valva regulatoare de presiune.");
        ...
        jLabel15.setText("• Ajusteaza viteza la relanti, cu surubul special.");

        jLabel13.setText("• Initiaza setarile de baza folosind echipamentul specific pentru diagnostic.");
