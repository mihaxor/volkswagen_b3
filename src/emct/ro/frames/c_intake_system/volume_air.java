...
public class volume_air extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        jLabel91.setText("• Deconecteaza canalul de admisie al aerului de la senzorul VAF.");

        jLabel90.setText("• Asigura-te ca motorul este oprit.");

        jLabel100.setText("NOTA: Incorporeaza senzorul pentru temperatura aerului de admisie (IAT).");

        jLabel101.setFont(new java.awt.Font("Dialog", 1, 14)); // NOI18N
        jLabel101.setForeground(new java.awt.Color(15, 89, 193));
        jLabel101.setText("&");

        jLabel89.setText("• Curata orice depunere de guma cu solvent. Daca este necesar.");
        ...
        jLabel86.setText("• Deconecteaza canalul de admisie al aerului de la senzorul VAF.");

        jLabel98.setFont(new java.awt.Font("Dialog", 1, 14)); // NOI18N
        jLabel98.setForeground(new java.awt.Color(15, 89, 193));
        jLabel98.setText("Verificarea Impamantarii - ");

        jLabel103.setText("• Deconecteaza conectorul multi-fisa al senzorului VAF.");

        jLabel102.setText("• Asigura-te ca motorul este oprit.");

        jLabel92.setText("• Deconecteaza conectorul multi-fisa al senzorului VAF.");
        ...
        jLabel88.setText("• Verifica buna functionare.");

        jLabel81.setFont(new java.awt.Font("Dialog", 1, 14)); // NOI18N
        jLabel81.setForeground(new java.awt.Color(15, 89, 193));
        jLabel81.setText("Operatiile de verificare - ");

        jLabel93.setText("• Actioneaza clapeta senzorului pe o distanta completa de deplasare.");
        ...
        jTable9.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
                {"2 si 3", "Valva inchisa", "610 \u2126 aprox."},
                {"2 si 4", "Valva inchisa", "60 \u2126 aprox. "},
                {"2 si 3", "Valva complet deschisa", "280 \u2126 aprox. "},
                {"2 si 4", "Valva complet deschisa", "780 \u2126 aprox. "}
            },
            new String [] {
                "Terminale", "Conditie", "Resistance"
            }
        ) {
        ...
        jLabel80.setText("Senzorul pentru volumul debitului de aer (VAF)");
        ...
        jLabel104.setText("• Verifica rezistenta intre borna multi-fisa si pamant. ");

        jLabel87.setText("• Actioneaza clapeta senzorului pe o distanta completa de deplasare.");

        jLabel97.setText("• Verifica rezistenta intre bornele senzorului VAF.");
        ...
        jLabel108.setText("Verificarea rezistentei - ");
        ...
        jLabel99.setText("• Schimbarea rezistentei trebuie sa fie lina.");
        ...
        jTable10.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
                {"2 si 4", "Motor la relanti", "0, 9 V aprox."},
                {"2 si 4", "2000 rpm", "1.5 V aprox."},
                {"2 si 4", "4000 rpm", "2.2 V aprox. "}
            },
            new String [] {
        ...
        jLabel109.setText("Verificarea tensiunii de alimentare - ");
        ...
        jLabel105.setText("• Asigura-te ca motorul este oprit.");

        jLabel106.setText("• Deconecteaza conectorul multi-fisa al senzorului VAF.");

        jLabel107.setText("• Porneste Motorul.");

        jLabel111.setText("• Verifica tensiunea intre terminalele bornei multi-fisa.");
        ...
        jLabel113.setText("• Asigura-te ca motorul este oprit.");

        jLabel114.setText("• Nu deconecta conectorul multi-fisa. Acceseaza terminalele senzorului multi-fisa VAF.");

        jLabel115.setText("• Verifica tensiunea intre bornele multi-fisa.");

        jLabel116.setText("• Porneste Motorul.");

        jLabel117.setText("• Creste RPM la valorile specificate.");

        jLabel118.setText("• Permite-i sa ruleze in gol.");

        jLabel119.setText("• Verifica voltajul intre terminalele multi-fisa.");

        jLabel120.setText("• Schimbarea de voltaj trebuie sa fie lina.");
