...
public class throttle_position extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        jLabel84.setText("• Verifica rezistenta intre terminalul multi-fisa al bornei si pamant.");

        jScrollPane8.setBorder(javax.swing.BorderFactory.createTitledBorder("Date Tehnice"));

        jTable8.setFont(new java.awt.Font("Dialog", 1, 12)); // NOI18N
        jTable8.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
                {"2 si 3", "Clapeta inchisa ", "0.3-1,7 V aprox. "},
                {"2 si 3", "Clapeta complet deschisa", "3-5 V aprox. "}
            },
            new String [] {
        ...
        jLabel83.setText("• Deconecteaza multi-fisa senzorului TP.");
        ...
        jLabel80.setText("Pozitia senzorului pedalei de acceleratie (TP)");
        ...
        jLabel85.setText("• Daca rezistenta nu este asemenea celei specificate: Verifica, cablurile. ");

        jLabel86.setFont(new java.awt.Font("Dialog", 1, 14)); // NOI18N
        jLabel86.setForeground(new java.awt.Color(15, 89, 193));
        jLabel86.setText("Verificari - ");
        ...
        jLabel87.setText("• Asigura-te ca motorul este oprit.");

        jLabel88.setText("• Deconecteaza multi-fisa senzorului TP.");

        jLabel89.setText("• Porneste Motorul.");

        jLabel90.setText("• Verifica rezistenta intre terminalele multi-fisa ale bornei.");

        jLabel91.setFont(new java.awt.Font("Dialog", 1, 14)); // NOI18N
        jLabel91.setForeground(new java.awt.Color(15, 89, 193));
        jLabel91.setText("Verificarea impamantarii - ");
        ...
        jLabel93.setText("• Nu deconecta conectorul multi-fisa. Accesati terminalele senzorului cu multi-fisa TP.");

        jLabel94.setText("• Porneste Motorul.");

        jLabel95.setText("• Verifica rezistenta intre terminalele multi-fisa ale bornei.");

        jLabel96.setText("• Actioneaza supapa de acceleratie in timp ce verifici tensiunea intre bornele 2 si 3.");

        jLabel97.setText("• Schimbarea tensiunii ar trebui sa fie lina.");
