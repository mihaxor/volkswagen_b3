...
public class idle_air extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        jLabel91.setText("• Deconecteaza multi-fisa supapei IAC ");
        ...
        jLabel93.setText("• Verifica tensiunea dintre borna multi-fisa si pamant.");
        ...
        jLabel80.setText("Valva pentru controlul aerului (IAC)");

        jLabel97.setText("•Daca tensiunea nu are aceeasi valoare ca si cea specificata: Verifica, cablurile si sigurantele.");

        jLabel108.setText("• Asigura-te ca motorul este oprit.");

        jLabel109.setText("• Deconecteaza multi-fisa supapei IAC ");

        jLabel110.setText("• Verifica rezistenta intre bornele ventilului IAC.");
