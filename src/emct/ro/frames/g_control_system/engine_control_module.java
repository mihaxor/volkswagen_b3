...
public class engine_control_module extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        jLabel14.setText("• Verifica tensiunea intre borna cutiei de decuplare si pamant.");

        jLabel12.setText("• Verifica tensiunea intre bornele cutiei de decuplare si pamant.");

        jLabel1.setFont(new java.awt.Font("Dialog", 1, 13)); // NOI18N
        jLabel1.setText("NOTA: Codurile de eroare trebuie sterse dupa terminarea testelor ECM. Consulta sectiunea Autodiagnosticare");

        jLabel9.setText("• Deconecteaza multi-mufa ECM.");

        jLabel8.setText("• Asigura-te ca motorul este oprit.");

        jLabel3.setFont(new java.awt.Font("Dialog", 1, 14)); // NOI18N
        jLabel3.setForeground(new java.awt.Color(15, 89, 193));
        jLabel3.setText("Modulul de control al motorului (ECM)");

        jLabel6.setFont(new java.awt.Font("Dialog", 1, 14)); // NOI18N
        jLabel6.setForeground(new java.awt.Color(15, 89, 193));
        jLabel6.setText("Verificarea Tensiunii de alimentare - Passat -");

        jLabel11.setText("• Porneste Motorul.");

        jLabel10.setText("• Deconecteaza caseta de decuplare la conectorul multi-mufa ECM.");

        jLabel15.setText("• Daca tensiunea nu este precum cea specificata: Verifica, cablurile, sigurantele si releele.");

        jLabel13.setText("• Da cateva chei motorului.");

        jLabel16.setFont(new java.awt.Font("Dialog", 1, 13)); // NOI18N
        jLabel16.setText("NOTA: Datorita dimensiunii reduse ale stifturilor multi-fisa ale cablajului ECM, se recomanda utilizarea unei casete de decuplare.");
        ...
        jTable11.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
                {"36 si pamant", "Motor Pornit", "Voltajul Bateriei"},
                {"38 si pamant", "Motor Pornit", "Voltajul Bateriei"},
                {"26 si pamant", "Da cateva chei motorului", "9 V aprox."}
            },
            new String [] {
        ...
        jLabel17.setText("NOTA: Releul de control al motorului trebuie sa fie montat si sa functioneze la parametrii optimi, pentru a efectua verificari ale tensiunii de alimentare.");

        jLabel7.setFont(new java.awt.Font("Dialog", 1, 14)); // NOI18N
        jLabel7.setForeground(new java.awt.Color(15, 89, 193));
        jLabel7.setText("Verificarea Impamantarii - Passat 1990-93 -");
        ...
        jLabel18.setText("• Asigura-te ca motorul este oprit.");

        jLabel19.setText("• Deconecteaza multi-mufa ECM.");

        jLabel20.setText("• Daca tensiunea nu este precum cea specificata: Verifica, cablurile.");

        jLabel21.setText("• Conecteaza caseta de decuplare la conectorul cu multi-mufa ECM.");

        jLabel22.setText("• Verifica tensiunea intre bornele cutiei de decuplare si pamant.");

        jLabel23.setFont(new java.awt.Font("Dialog", 1, 14)); // NOI18N
        jLabel23.setForeground(new java.awt.Color(15, 89, 193));
        jLabel23.setText("Verificarea Impamantarii- Passat 1994-95 -");
        ...
        jScrollPane13.setBorder(javax.swing.BorderFactory.createTitledBorder("Date Tehnice"));
        ...
        jLabel25.setText("• Deconecteaza multi-mufa ECM.");

        jLabel26.setText("• Conecteaza caseta de decuplare la conectorul cu multi-mufa ECM.");

        jLabel27.setText("• Verifica tensiunea intre borna cutiei de decuplare si pamant.");

        jLabel28.setText("• Daca tensiunea nu este precum cea specificata: Verifica, cablurile.");

        jLabel29.setFont(new java.awt.Font("Dialog", 1, 14)); // NOI18N
        jLabel29.setForeground(new java.awt.Color(15, 89, 193));
        jLabel29.setText("Verificarea Tensiunii de alimentare - Golf/Vento & Corrado -");
        ...
        jTable14.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
                {"8 si pamant", "Motor Pornit", "Voltajul Bateriei"},
                {"23 si pamant", "Motor Pornit", "Voltajul Bateriei"},
                {"32 si pamant", "Da cateva chei motorului", "9 V aprox."}
            },
            new String [] {
                "Terminale", "Conditie", "Voltaj"
            }
        ...
        jLabel31.setText("• Asigura-te ca motorul este oprit.");

        jLabel32.setText("• Deconecteaza multi-mufa ECM.");

        jLabel33.setText("• Conecteaza caseta de decuplare la conectorul cu multi-mufa ECM.");

        jLabel34.setText("• Porneste Motorul.");

        jLabel35.setText("• Verifica tensiunea intre bornele cutiei de decuplare si pamant.");

        jLabel36.setText("• Da cateva chei motorului.");

        jLabel37.setText("• Verifica tensiunea intre borna cutiei de decuplare si pamant.");

        jLabel38.setText("• Daca tensiunea nu este precum cea specificata: Verifica, cablurile, sigurantele si releele.");
        ...
        jScrollPane15.setBorder(javax.swing.BorderFactory.createTitledBorder("Date Tehnice"));
        ...
        jLabel40.setText("• Asigura-te ca motorul este oprit.");

        jLabel41.setText("• Deconecteaza multi-mufa ECM.");

        jLabel42.setText("• Conecteaza caseta de decuplare la conectorul cu multi-mufa ECM.");

        jLabel43.setText("• Verifica tensiunea intre borna cutiei de decuplare si pamant.");

        jLabel44.setText("• Daca tensiunea nu este precum cea specificata: Verifica, cablurile.");
