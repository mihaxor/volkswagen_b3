...
public class crankshaft extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        jLabel91.setText("• Nu deconecta multi-mufa. Acceseaza terminalele cu multi-mufa ale senzorului CKP.");

        jLabel90.setText("• Asigura-te ca motorul este oprit.");

        jLabel100.setText("NOTA: Incorporat in distribuitor");
        ...
        jLabel86.setText("• Deconecteaza multi-mufa senzorului CKP. ");

        jLabel92.setText("• Conecteaza lampa de control LED intre bornele multi-fisa.");

        jLabel88.setText("• Verifica tensiunea intre terminalele bornei multi-fisa.");

        jLabel81.setFont(new java.awt.Font("Dialog", 1, 14)); // NOI18N
        jLabel81.setForeground(new java.awt.Color(15, 89, 193));
        jLabel81.setText("Verificarea tensiunii de alimentare - ");

        jLabel93.setText("• Da cateva chei motorului.");

        jLabel95.setFont(new java.awt.Font("Dialog", 1, 14)); // NOI18N
        jLabel95.setForeground(new java.awt.Color(15, 89, 193));
        jLabel95.setText("Verificarea semnalului - ");
        ...
        jLabel80.setText("Senzorul de pozitie al arborelui cotit (CKP)");

        jLabel87.setText("• Porneste Motorul.");
        ...
        jLabel101.setText("NOTA: Deconecteaza multi-mufa injectorului inainte de a face teste pe motor, pentru a evita pornirea motorului.");

        jLabel94.setText("• Verifica daca led-ul da flash-uri.");
