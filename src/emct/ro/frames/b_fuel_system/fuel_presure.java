...
public class fuel_presure extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        jLabel41.setText("• Conecteaza manometrul la conducta de alimentare cu combustibil.");
        ...
        jLabel38.setText("Verificari -");

        jLabel39.setText("• Asigura-te ca motorul este oprit.");

        jLabel45.setText("• Compara presiunea regulata indicata cu presiunea specificata.");

        jLabel42.setText("• Asigura-te ca robinetul conductei este inchis.");

        jLabel50.setText("• Reconecteaza furtunul cu vacuum.");

        jScrollPane5.setBorder(javax.swing.BorderFactory.createTitledBorder("Date Tehnice"));

        jTable5.setFont(new java.awt.Font("Dialog", 1, 12)); // NOI18N
        jTable5.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
                {"Sistem", "Vacuum OFF", "3,0 bari"},
                {"Regulat", "Vacuum ON", "2,5 bari"},
                {"Rezistent", "Dupa 10 minute", "2 bari"}
            },
            new String [] {
                "Presiune", "Conditie", "Valoare"
            }
        ) {
        ...
        jLabel43.setText("• Porneste Motorul. ");

        jLabel46.setText("• Deconecteaza furtunul cu vacuum, de la regulatorul presiunii combustibilului.");

        jLabel49.setText("• Dupa 10 minute, verifica presiunea de sustinere.  ");

        jLabel40.setText("• Deconecteaza conducta de alimentare cu combustibil a injectorului cu pornire la rece.");
        ...
        jLabel37.setText("Presiunea combustibilului");

        jLabel44.setText("• Lasa motorul sa ruleze la relanti . ");

        jLabel48.setText("• Opreste motorul. ");

        jLabel51.setText("• Compara presiunea indicata de sistem cu presiunea specificata.");
