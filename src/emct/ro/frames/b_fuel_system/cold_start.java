...
public class cold_start extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        jLabel114.setText("• Asigura-te ca motorul este oprit.");
        ...
        jLabel138.setText("• Deconecteaza conectorul multiplu al senzorului pentru temperatura lichidului de racire a motorului. ( ECT ) ");
        ...
        jTable13.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
                {"Turarea Motorului", "Spray cu carburant pentru 1-4 secunde"},
                {"Rezistorul dintre terminale", "3800 \u2126"}
            },
            new String [] {
                "Conditie", "Rezultat"
            }
        ...
        jLabel111.setText("• Nu deconecta multi-conectorul. Deconecteaza injectorul de pornire la rece.");
        ...
        jLabel119.setText("• Usuca valva injectorului cu pornire la rece. ");

        jLabel118.setText("• Verifica o spray-ere conica uniforma a combustibilului.");

        jLabel110.setText("• Asigura-te ca motorul este oprit.");

        jLabel112.setText("• Pozitioneaza injectorul peste containerul potrivit.");

        jLabel120.setText("• Verifica, ca nicio picatura de conbustibil sa nu curga prin valva.");

        jLabel143.setText("• Daca lampa LEO nu da flash-uri: Verifica, cablurile.");

        jLabel117.setText("• Da o cheie motorului ( Dar nu il porni ).");

        jLabel136.setFont(new java.awt.Font("Dialog", 1, 14)); // NOI18N
        jLabel136.setForeground(new java.awt.Color(15, 89, 193));
        jLabel136.setText("Verificarea Semnalului -");
        ...
        jLabel144.setText("Operatia de verificare-");
        ...
        jTable12.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
                {"Zgomotul Motorului", "Licareste pentru 1-4 secunde "},
                {"Rezistorul dintre terminale", "3800 \u2126"}
            },
            new String [] {
                "Conditie", "LED"
        ...
        jLabel113.setText("NOTA: Deconecteaza mufa multipla de cablaj a injectorului, inainte de a efectua teste pe motor, pentru a preveni motorul sa porneasca. ");
        ...
        jLabel137.setText("• Deconecteaza mufa multipla de cablaj a injectorului. ");
        ...
        jLabel141.setText("• Da o cheie motorului.( Dar nu il porni ) .");

        jLabel140.setText("• Conecteaza lampa de test LEO intre terminalele cu conectori multiplii ale injectorului de pornire la rece.");
        ...
        jLabel142.setText("• Verifica daca lampa LEO da flash-uri. ");

        jLabel116.setText("• Conecteaza rezistorul intre terminalele senzorului multiplu pentru temperatura lichidului de racire a motorului. ( ECT )");

        jLabel115.setText("• Deconecteaza senzorul cu conectare multipla pentru temperatura lichidului de racire a motorului ( ECT ).");
        ...
        jLabel108.setText("Injector de pornire la rece");

        jLabel139.setText("• Conecteaza rezistorul intre terminalele senzorului multiplu pentru temperatura lichidului de racire a motorului (ECT).  ");
